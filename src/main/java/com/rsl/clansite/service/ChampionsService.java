...
public class ChampionsService {
    ...
    @Autowired
    public ChampionsService(final ChampionRepository championRepository, final AuditLogService auditLogService) {
    ...
    public void updateChampion(String id, ChampionEntryDTO dto, Authentication authentication) throws ChampionSaveException {
        ...
        String autoGeneratedFilename = dto.getName().toLowerCase().replace(" ", "-") + ".png";
        entity.setImagename(autoGeneratedFilename);
